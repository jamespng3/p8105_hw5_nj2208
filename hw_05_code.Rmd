...
There is linear relationship between the average beta1 values of the trials where the null was rejected.While the trials where the null was rejected does not approximately equal the true value of beta1, you could potentially use this data to extrapolate beta1.
